...
//        initRoadData();
    ...
    private void initRoadData(final List<LatLng> polylines, final double distance) {
        // init latlng data
//        double centerLatitude = 45;
...
//        polylines.add(new LatLng(latitude, longtitude));
        ...
        markerOptions = new MarkerOptions().flat(true).anchor(0.5f, 0.5f).icon(BitmapDescriptorFactory
                .fromResource(R.mipmap.ic_launcher)).position(polylines.get(0)).rotate((float) getAngle(0));
