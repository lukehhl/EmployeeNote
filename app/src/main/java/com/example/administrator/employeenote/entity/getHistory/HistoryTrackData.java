...
//                    list.add(latLng);
//                }
//                if(Math.abs(Long.valueOf(pois.getLoc_time()) - Long.valueOf(points.get(i+1).getLoc_time())) >1800){
//                    list.add(null);
//                }
//            } else list.add(new LatLng(points.get(i).getLocation().get(1), points.get(i).getLocation().get(0)));
//
//        }
//        return list;
//
//    }
    ...
    public String toString() {
        return "HistoryTrackData [status=" + status + ", size=" + size + ", total=" + total + ", entity_name="
                + entity_name + ", points =" + points.toString() + ", message=" + message + "]";
    }
